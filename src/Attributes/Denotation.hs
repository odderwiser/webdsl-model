module Attributes.Denotation where
import Layout.Effects (Attribute, State, put)
import Attributes.Syntax
import Utils.Composition
import Utils.Environment
import Utils.Fix
import Utils.Free
import Layout.Handlers (attributeH)
import Attributes.Handlers
import Data.List (delete)
import Data.Maybe (fromJust)
import Attributes.Effects (render)
